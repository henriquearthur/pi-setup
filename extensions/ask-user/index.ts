 ...
 *
 * Adapted from https://github.com/davis7dotsh/my-pi-setup/tree/main/extensions/ask-user
 * (effect dependency replaced with a plain promise + AbortSignal).
 */
...
export default function askUser(pi: ExtensionAPI) {
  pi.registerTool({
    ...
    async execute(_toolCallId, params, signal, _onUpdate, ctx) {
      ...
      const uiSignal: AbortSignal = signal ?? new AbortSignal();
