 ...
 * types. The pi backend translates its native session event stream into the
...
/**
 * Reasoning-effort scale (pi's thinking levels). Omitted = inherit the
 * parent level.
 */
...
export interface SpawnTask {
  ...
  readonly cwd: string;
  /**
   * Model hint: "provider/model-id" or bare model id.
   * Omitted = inherit the parent model.
   */
  readonly model?: string;
  /** Reasoning-effort scale; maps directly to pi thinking levels. */
